...
# I customize a logoutview instead of using built in function
#I should have add this code line to the url module "path('logout/', auth_view.LogoutView.as_view(next_page="login"), name="logout"),"
